...
Route::get('/auth/google', [SocialiteController::class, 'googleredirect'])->name('singin');

Route::get('callback/google', [SocialiteController::class, 'callbackgoogle']);

Route::get('/auth/github', [SocialiteController::class, 'gitredirect'])->name('singin');
